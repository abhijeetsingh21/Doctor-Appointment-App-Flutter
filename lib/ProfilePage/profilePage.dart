...
import 'package:doctors_appointment/ProfilePage/domain/profile_cubit.dart';
                          ...
                          children: [
                            ...
                            SettingFields(
                              ...
                              onChanged: (val) => context
                                  .read<ProfileCubit>()
                                  .onTextMessageTap(val),
                              value: state.txtMessageToggle,
                            ),
                            SettingFields(
                              icon: Icon(
                              ...
                              onChanged: (bool val) => context
                                  .read<ProfileCubit>()
                                  .onCustomerCallsTap(val),
                              value: state.customerCallsToggle,
                            ),
                          ],
                        ),
                      ),
